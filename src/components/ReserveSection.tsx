...
export default function ReserveSection() {
  return (
    <section id="reserve" className="py-20 md:py-28 bg-gradient-to-b from-charcoal to-charcoal/95 text-warm-white">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <ScrollReveal animation="fade-up">
          <p className="text-[10px] md:text-xs tracking-[0.3em] text-gold-light uppercase mb-3">Reservation</p>
        ...
        <ScrollReveal animation="fade-up" delay={200} className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6" stagger={150}>
          ...
          <a href="https://yukisiki-kogao.com/" target="_blank" rel="noopener noreferrer"
        ...
        <ScrollReveal animation="fade-in" delay={400}>
          <p className="mt-6 text-[10px] text-warm-gray tracking-wider">受付時間 10:00〜22:00 ／ 不定休</p>
        </ScrollReveal>
      </div>
    </section>
  );
