...
const cases = [
  { age: "30代女性", concern: "顔の左右差・エラ張り", result: "左右のバランスが整い、フェイスラインがすっきり", before: "/images/before-after/case01-before.jpg", after: "/images/before-after/case01-after.jpg" },
  { age: "40代女性", concern: "たるみ・ほうれい線", result: "頬の位置が上がり、ほうれい線が目立たなく", before: "/images/before-after/case02-before.jpg", after: "/images/before-after/case02-after.jpg" },
  { age: "20代女性", concern: "丸顔・むくみ", result: "骨格から整えることでシャープな輪郭に", before: "/images/before-after/case03-before.jpg", after: "/images/before-after/case03-after.jpg" },
];
    ...
    <section className="py-20 md:py-28 bg-warm-white">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <ScrollReveal className="grid md:grid-cols-3 gap-6" stagger={200}>
          {cases.map((c, i) => (
            <div key={i} className="rounded-2xl overflow-hidden bg-ivory/50 glass-card luxury-hover">
