      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="md:flex md:gap-10">
          ...
          <div className="md:w-1/2 space-y-6">
            <h3 className="font-serif text-lg tracking-wider text-charcoal">
              YUKISIKI 小顔矯正 中目黒
            </h3>
            ...
            <div className="space-y-5">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-sm text-charcoal tracking-wider">
                    〒153-0051
                  </p>
                  <p className="text-sm text-charcoal tracking-wider">
                    東京都目黒区上目黒3-15-2 W-1
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <a
                    ...
                    className="text-sm text-charcoal tracking-wider hover:text-gold transition-colors"
                  >
                    080-6320-2573
                  </a>
                </div>
