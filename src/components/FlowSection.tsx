...
const steps = [
  {
    num: "01",
    title: "ご予約",
    desc: "お電話またはWeb予約フォームからご予約ください。ご不明な点はお気軽にお問い合わせを。",
  },
  {
    num: "02",
    title: "カウンセリング",
    desc: "お顔の状態を丁寧にヒアリング。骨格の歪みの原因を分析し、最適な施術プランをご提案します。",
  },
  {
    num: "03",
    title: "施術",
    desc: "29個の骨格にアプローチする独自の手技で、骨格の歪みを根本から整えます。ほぼ痛みのない施術です。",
  },
  {
    num: "04",
    title: "アフターケア",
    desc: "施術後の状態を確認し、ご自宅でのケア方法や通院頻度のアドバイスをお伝えします。",
  },
];
          ...
          {steps.map((s, i) => (
            <div key={i} className="relative flex gap-6 md:gap-8">
              ...
              <div className="pb-10 md:pb-12 pt-1.5">
                <h3 className="font-serif text-base md:text-lg tracking-wider text-charcoal mb-2">
                  {s.title}
                </h3>
